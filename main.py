...
#loading model
with open('model.pkl', 'rb') as pipe:
...
def index():
    ...
    return render_template('index.html',squareMeters=squareMeters,numberOfRooms=numberOf
...
def predict():
   ...
   input_data = pd.DataFrame({'squareMeters': [squareMeters],
                            ...
                            'price': [price]})#fetching from main file
